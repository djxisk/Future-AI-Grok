...
class ProbeFallbackTests(unittest.TestCase):
    def test_proxy_is_used_for_owned_probe_client(self):
        with (
            patch("account_pipeline.httpx.Client") as client_factory,
            patch(
                "account_pipeline._grok_probe.probe_account",
        ...
        self.assertEqual(
            "http://127.0.0.1:7897",
            client_factory.call_args.kwargs["proxy"],
        )
